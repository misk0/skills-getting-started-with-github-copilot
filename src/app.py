...
activities = {
    ...
    "Soccer Team": {
        "description": "Develop teamwork and soccer skills through drills and scrimmages",
    ...
    "Debate Team": {
        "description": "Build public speaking and critical thinking through competitive debate",
